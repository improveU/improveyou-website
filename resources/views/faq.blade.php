...
<section id="faq">
    <div class="faqWrapper">
        ...
        <button class="faqContainer">
            ...
            <p class="answer"> We are currently not working on a mobile app, but for now you can open our website on your phone's browser. </p>
        </button>
        ...
        <button class="faqContainer">
            ...
            <p class="answer"> In settings, under details, you can cancel your subscription. Your data will be deleted upon thirty days of the subscription ending. </p>
        </button>

        <button class="faqContainer">
            <p class="question"> Are there any integrations or API available for the platform? </p>
            <p class="answer"> We are currently not offering any API, but that might change. If you want to stay in the loop you can subscribe to our newsletter </p>
        </button>
